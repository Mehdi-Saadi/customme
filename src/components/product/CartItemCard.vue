...
<template>
    <div class="flex items-center border-b">
        <div class="grow flex items-center text-sm font-bold space-x-6 rtl:space-x-reverse">
            ...
            <span>
                {{ toPersianNums(cartItem.product.attributes.price) }} تومان
            </span>
        </div>
        <div
            class="flex items-center justify-between border text-sm rounded-lg select-none"
        >
            <PlusSmallIcon
